...
public class PointScanner {
	...
	public void scan() {
		...
		medianCoordinatePoint = new Point(p.getX(), b.getX());
	}
	...
	public void writeMCPToFile() throws FileNotFoundException {
		try {
			FileWriter fwrite = new FileWriter("C:\\Users\\Trist\\OneDrive\\Desktop\\COM S 228\\hw2\\edu\\iastate\\cs228\\hw2\\outfile.txt");
			fwrite.write(toString());
			fwrite.close();
		} catch (Exception e) {
